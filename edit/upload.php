...
//     echo $_FILES['product_file']['tmp_name'];
    ...
    if( !$error ) {
        ...
        $size_x = $_POST["size_x"];
        $size_y = $_POST["size_y"];
        $cheight = $_POST["cheight"]!="NULL"?$_POST["cheight"]:NULL;
        $dtg = $_POST["dtg"];
        $query = "INSERT INTO products(mockup_name,mockup_code,width,height,x,y,user_id,blend_mode,opacity,admin,mockup_list,top_left_x,top_left_y,top_right_x,top_right_y,bottom_left_x,bottom_left_y,bottom_right_x,bottom_right_y,perspective, position_x, position_y, size_x, size_y, cheight, dpi,provider,print_location, print_mode, product_cost, product_price,texture_dark, texture_white, dtg) VALUES('$productname','$productcode','$width','$height','$x','$y','$user','$blend_mode','$opacity','$admin','$mockup_list',$top_left_x,$top_left_y,$top_right_x,$top_right_y,$bottom_left_x,$bottom_left_y,$bottom_right_x,$bottom_right_y,'1',$position_x,$position_y,$size_x,$size_y,$cheight,$dpi,'$provider','$print_location','$print_mode',$productcost,$productprice, $texture_dark, $texture_white, $dtg)";
