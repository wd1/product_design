...
$external_dynamic = (!empty($options['external-dynamic-css']) && $options['external-dynamic-css'] == 1) ? 'on' : 'off';
	...
	.nectar_team_member_close .inner { border-color:'.$options["accent-color"].'; }
	...
	if(!empty($options['overall-bg-color'])) {
		echo 'html .container-wrap, .project-title, html .ascend .container-wrap, html .ascend .project-title, html body .vc_text_separator div, html .carousel-wrap[data-full-width="true"] .carousel-heading, html .carousel-wrap span.left-border, html .carousel-wrap span.right-border, .single-post.ascend #page-header-bg.fullscreen-header, .single-post #single-below-header.fullscreen-header,
	...
	if(!empty($options['header-color']) && $options['header-color'] == 'custom') {
		...
		if(!empty($options['header-font-color'])) {
			...
			body[data-header-format="left-header"] #social-in-menu a { color:'.$options['header-font-color'].'!important; }';
			...
			header#top .slide-out-widget-area-toggle.mobile-icon .lines-button.x2 .lines:before, header#top .slide-out-widget-area-toggle.mobile-icon  .lines-button.x2 .lines:after, header#top .slide-out-widget-area-toggle[data-icon-animation="simple-transform"].mobile-icon .lines-button:after, header#top .slide-out-widget-area-toggle[data-icon-animation="spin-and-transform"].mobile-icon .lines-button.x2 .lines { background-color:'.$options['header-font-color'].'!important; }';
		...
		if(!empty($options['header-slide-out-widget-area-hover-color'])) {
			echo 'body #slide-out-widget-area.fullscreen a:hover, body #slide-out-widget-area.slide-out-from-right a:hover, #slide-out-widget-area.fullscreen-alt .inner .off-canvas-menu-container li a .clip-wrap, #slide-out-widget-area.slide-out-from-right-hover .inner .off-canvas-menu-container li a .clip-wrap, #slide-out-widget-area.slide-out-from-right-hover.no-text-effect .inner .off-canvas-menu-container li a:hover, html body #slide-out-widget-area a.slide_out_area_close:hover .icon-default-style[class^="icon-"] { color:'.$options['header-slide-out-widget-area-hover-color'].'!important; }';
	...
	if(!empty($options['footer-custom-color']) && $options['footer-custom-color'] == '1') {
		...
		if(!empty($options['footer-background-color'])) {
			echo '#footer-outer, #nectar_fullscreen_rows > #footer-outer.wpb_row .full-page-inner-wrap { background-color:'.$options['footer-background-color'].'!important; } #footer-outer #footer-widgets { border-bottom: none!important; } #footer-outer #footer-widgets .col ul li { border-bottom: 1px solid rgba(0,0,0,0.1)!important; } #footer-outer #footer-widgets .col .widget_recent_comments ul li { background-color: rgba(0, 0, 0, 0.07)!important; border-bottom: 0px!important;} ';
		}
		...
		if(!empty($options['footer-copyright-icon-hover-color'])) {
			echo '#footer-outer #copyright li a:hover i, #footer-outer[data-cols="1"] #copyright li a:hover i { border-color: '.$options['footer-copyright-icon-hover-color'].'!important; color:'.$options['footer-copyright-icon-hover-color'].'!important; }';
		}
