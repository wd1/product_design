    ...
    function($) {
        vc.debug = !1, vc.map = _.isUndefined(window.vc_mapper) ? {} : window.vc_mapper, vc.roles = _.isUndefined(window.vc_roles) ? {} : window.vc_roles, vc.Storage = function() {
            ...
            setContent: function(content) {
              ...
              tiny && window.switchEditors.go("content", "html"), $("#content").val(content), tiny && !editor_hidden && window.switchEditors.go("content", "tmce") */
              ...
              if ( tiny ) {
                  ...
                  //portfolio extra
                       ...
                       window.switchEditors.go('_nectar_portfolio_extra_content', 'html');
                   }
                  //window.switchEditors.go( 'content', 'html' );
              }
              ...
              //portfolio extra
                   ...
                   $('textarea#_nectar_portfolio_extra_content').val(content);
               }
              ...
              if ( tiny && ! editor_hidden ) {
                  ...
                  //portfolio extra
                       ...
                       window.switchEditors.go('_nectar_portfolio_extra_content', 'tmce');
                   }
              }
              /* nectar addition end */ 
            },
