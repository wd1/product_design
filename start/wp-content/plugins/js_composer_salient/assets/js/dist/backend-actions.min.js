    ...
    vc.events.on("vc:access:initialize", function(access) {
        ...
        if (front = "", back = "", access.can("fe_editor") && (front = '<span class="vc_spacer"></span><a class="wpb_switch-to-front-composer" href="' + $("#wpb-edit-inline").attr("href") + '">' + window.i18nLocale.main_button_title_frontend_editor + "</a>"), access.can("classic_editor") ? access.can("be_editor") && (back = '<span class="vc_spacer"></span><a class="wpb_switch-to-composer" href="javascript:;">' + window.i18nLocale.main_button_title_backend_editor + "</a>") : ($("#postdivrich").hide(), access.can("be_editor") && _.defer(function() {
          ...
          if($('#nectar-metabox-portfolio-extra').length == 0){
              $buttonsContainer = $titleDiv.length ? $('<div class="composer-switch"><span class="logo-icon"></span>' + back + front + "</div>").insertAfter($titleDiv) : $('<div class="composer-switch"><span class="logo-icon"></span>' + back + front + "</div>").prependTo("#post-body-content"); 
          } 
          //portfolio extra
          else {
              $buttonsContainer = $('<div class="composer-switch"><span class="logo-icon"></span><span class="vc_spacer"></span><a class="wpb_switch-to-composer" href="javascript:;">' + window.i18nLocale.main_button_title_backend_editor + '</a>' +  '</div>').prependTo('#normal-sortables');      
          }

          access.can("classic_editor") && ($switchButton = $buttonsContainer.find(".wpb_switch-to-composer"), $switchButton.click(function(e) {
